#TODO: Transform this code to use argparse instead of sys.argv
import random
import sys
...
if __name__ == "__main__":
    ...
    dataset_content: List[str] = [str(bodies)]
    output_file = output if output is not None else f"{DEFAULT_FILENAME_PREFIX}{bodies}"
